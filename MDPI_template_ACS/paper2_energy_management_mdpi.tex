...
\dataavailability{The virtual-prototype source code, reproduction scripts, including the declared full-information oracle diagnostic, and JSON outputs supporting these results are included in the accompanying submission archive. A versioned public repository and archival DOI must be supplied before publication.}
