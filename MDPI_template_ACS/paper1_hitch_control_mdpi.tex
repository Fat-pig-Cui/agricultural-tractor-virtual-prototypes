...
\dataavailability{The virtual-prototype source code, reproduction scripts, machine-readable parameter manifest, assumption register, traceability exporter, and JSON outputs supporting these results are included in the accompanying submission archive. A versioned public repository and archival DOI must be supplied before publication.}
